...
TEST(UniformQuantizer, PositiveRange) {  // NOLINT(cert-err58-cpp)
    ...
    EXPECT_EQ(q.indexToReconstructionValue(0), 1);
    EXPECT_EQ(q.indexToReconstructionValue(1), 3);
}
...
TEST(UniformQuantizer, NegativeRange) {  // NOLINT(cert-err58-cpp)
    ...
    EXPECT_EQ(q.indexToReconstructionValue(0), -4);
    EXPECT_EQ(q.indexToReconstructionValue(1), -2);
}
...
TEST(UniformQuantizer, EightBinning) {  // NOLINT(cert-err58-cpp)
    ...
    EXPECT_EQ(q.indexToReconstructionValue(0), 3);
    EXPECT_EQ(q.indexToReconstructionValue(1), 8);
    EXPECT_EQ(q.indexToReconstructionValue(2), 13);
    EXPECT_EQ(q.indexToReconstructionValue(3), 18);
    EXPECT_EQ(q.indexToReconstructionValue(4), 23);
    EXPECT_EQ(q.indexToReconstructionValue(5), 28);
    EXPECT_EQ(q.indexToReconstructionValue(6), 33);
    EXPECT_EQ(q.indexToReconstructionValue(7), 38);
}
