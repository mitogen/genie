...
class LocalAssemblyReadEncoder {
   private:
    ...
    format::mpegg_rec::MpeggRecord::ClassType getClass(const std::string& read, const std::string& cigar,
   ...
   public:
    ...
    format::mpegg_rec::MpeggRecord::ClassType addPair(const format::sam::SamRecord& rec1, const std::string& ref1,
                                                      const format::sam::SamRecord& rec2, const std::string& ref2);
